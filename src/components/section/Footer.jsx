...
const Footer = () => {
  ...
  return (
    <div
      className={`${theme} flex flex-col items-center justify-center h-[40vh] bg-secondColor transition-colors duration-500`}
    >
      <div className="flex justify-center gap-10 sm:gap-16 lg:gap-0">
        <MagneticButtons>
          <svg
            className="lg:h-[150px] lg:p-[50px] cursor-pointer fill-mainColor transition-colors duration-500 h-[50px] "
            id="Layer_2"
            data-name="Layer 2"
